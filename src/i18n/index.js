...
export const translations = {
  'zh-CN': {
    ...
    clashPreserveMode: 'Clash 原样保留模式',
    clashPreserveModeTip: '保留自定义 Clash 配置的注释、规则组和规则，只向 proxies 追加新节点',
    saveConfig: '保存配置',
    savingConfig: '保存中...',
  ...
  'en-US': {
    ...
    clashPreserveMode: 'Clash Preserve Mode',
    clashPreserveModeTip: 'Keep custom Clash comments, groups, and rules as-is, and only append new nodes to proxies',
  ...
  'fa': {
    ...
    clashPreserveMode: 'حالت حفظ Clash',
    clashPreserveModeTip: 'نظرات، گروه‌ها و قوانین Clash سفارشی را حفظ می‌کند و فقط نودهای جدید را به proxies اضافه می‌کند',
  ...
  'ru': {
    ...
    clashPreserveMode: 'Режим сохранения Clash',
    clashPreserveModeTip: 'Сохраняет комментарии, группы и правила Clash как есть и только добавляет новые узлы в proxies',
